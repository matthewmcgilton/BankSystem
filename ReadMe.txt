...
PLEASE READ ProjectDescription.pdf in the Example Files folder for more information!!!
...
2) Place a BankTransIn.txt file in the directory. This file must contain a list of transactions for the bank to complete
   ...
   b. ProjectDescription.pdf in the Example Files folder includes a list of all the commands along with their intended functionaliy
3) Run the driver.py
